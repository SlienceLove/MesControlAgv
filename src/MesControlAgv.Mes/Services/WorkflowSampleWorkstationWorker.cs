    ...
    ILogger? logger = null)
{
    ...
    public async Task ProcessAsync(CancellationToken cancellationToken)
    {
        ...
        foreach (var workItem in await workflows.ListSampleWorkstationDispatchableNodesAsync(cancellationToken))
        {
            ...
            var claimed = await workflows.ClaimNodeExecutionAsync(workItem.NodeExecution.Id, cancellationToken);
    ...
    ILogger<WorkflowSampleWorkstationWorker> logger) : BackgroundService
{
    ...
    private WorkflowSampleWorkstationDispatcher CreateDispatcher(IServiceScope scope) =>
        new(

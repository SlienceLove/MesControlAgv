...
public sealed class SampleWorkstationAdapterClient(HttpClient client) : ISampleWorkstationReader, ISampleWorkstationController
{
    ...
    public Task<SampleWorkstationOperationResponse> AddTrajectoryAsync(
        ...
        CancellationToken cancellationToken) =>
        PostAsync(
            $"api/workstations/{EscapeRequired(deviceId, nameof(deviceId))}/tasks/{EscapeRequired(request.TaskNo, nameof(request.TaskNo))}/trajectory",
            request,
            cancellationToken);
    ...
    public Task<SampleWorkstationOperationResponse> StartExperimentAsync(
        ...
        CancellationToken cancellationToken) =>
        PostAsync(
            $"api/workstations/{EscapeRequired(deviceId, nameof(deviceId))}/tasks/{EscapeRequired(request.TaskNo, nameof(request.TaskNo))}/start",
            request,
            cancellationToken);
